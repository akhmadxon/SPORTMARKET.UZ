...
import productImage from "@/public/img7.png";
import avatar from "@/public/avatar.png";
import cart from "@/public/cart.png";
import sliders from "@/public/sliders.png";
import share from "@/public/share.png";

const ProductSwiper = ({ imgList }) => (
  <Swiper
    spaceBetween={10}
    slidesPerView={1}
    navigation
...
const ProductInfo = () => (
  <div className="md:w-1/2 p-8 bg-white mb-[40px]">
    ...
    <p className="mt-2 text-gray-700">
      В составе томатов в большом количестве содержатся сахары, ликопин, пектин, бетакаротин, витамины.
    </p>
...
const ProductDescription = () => (
  <div className="bg-white p-6 rounded-lg shadow-md">
    ...
    <h4 className="text-xl font-semibold">Гантель виниловая, 2 х 3 кг</h4>
    <p className="mt-4 text-gray-700">
      В составе томатов в большом количестве содержатся сахары, клетчатка, пектины, бета-каротин, витамины.
    </p>
...
const Reviews = () => (
  <div className="bg-white p-6 rounded-lg shadow-md">
    ...
    <ReviewCard name="Шахзод Анаров" review="В составе томатов в большом количестве содержатся сахары, ликопин, пектин, бетакаротин, витамины." />
    <ReviewCard name="Шахзод Анаров" review="В составе томатов в большом количестве содержатся сахары, ликопин, пектин, бетакаротин, витамины." />
    <a href="#" className="mt-4 text-yellow-400 block">Все отзывы</a>
  </div>
);
